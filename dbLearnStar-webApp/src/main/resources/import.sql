...
DELETE FROM dblearnstar.student WHERE person_id=(select person_id from dblearnstar.person where user_name='admin') and role_id=(select role_id from dblearnstar.roles where name='ADMINISTRATOR');
